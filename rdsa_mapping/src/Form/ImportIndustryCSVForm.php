...
class ImportIndustryCSVForm extends FormBase {
  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'industry_csv_import_form';
  }
  /**
   * {@inheritdoc}
   */
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    foreach($data as $row) {
      $operations[] = ['\Drupal\rdasa_mapping\addImportIndustryCSVContent::addImportIndustryCSVContentItem', [$row]];
    }
    ...
    $batch = array(
      ...
      'finished' => '\Drupal\rdasa_mapping\addImportIndustryCSVContent::addImportIndustryCSVContentItemCallback',
    );
    batch_set($batch);
  }
